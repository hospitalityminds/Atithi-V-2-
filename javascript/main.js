...
document.querySelector('#TeamPopuplink').addEventListener("click",function(){
	document.querySelector('#TeampopUpMain').classList.add("active");
	console.log("click");
});


document.querySelector('#Teamcancel').addEventListener("click",function(){
	document.querySelector('#TeampopUpMain').classList.remove("active");
    console.log("cancel");
});
